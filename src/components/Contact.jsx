...
export const Contact = () => {
  ...
  const [buttonText, setButtonText] = useState('Sorry Amiel');
              ...
              {({ isVisible }) =>
                ...
                {/* <form action="https://formbold.com/s/oJgkE" method="POST">
                  <Row>
                    ...
                    <Col size={12} sm={6} className="px-1">
                      <input type="text" required name="lastname" value={formDetails.lasttName} placeholder="Last Name*" onChange={(e) => onFormUpdate('lastName', e.target.value)}/>
                    </Col>
                    <Col size={12} sm={6} className="px-1">
                    ...
                    <Col size={12} className="px-1">
                      <textarea rows="6" required name="message" value={formDetails.message} placeholder="Message*" onChange={(e) => onFormUpdate('message', e.target.value)}></textarea>
